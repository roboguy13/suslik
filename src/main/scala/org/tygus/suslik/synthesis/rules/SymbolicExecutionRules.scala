...
import org.tygus.suslik.logic.unification._
...
//       // val f = _f.refreshExistentials(goal.vars)._1
//       //
...
//       //   callSubPost = goal.post.copy(sigma = largSubHeap) // ???
//       //
//       //   sourceAsn = f.pre
...
//       //   // callGoal = SuspendedCallGoal(goal.pre, goal.post, f.post, goal.toCall, Map(), sub)
//       //   // results = UnfoldingRules.CallRule.apply(goal)
//       //    callGoal = goal.copy()
//       // } yield {
//       //  // results
...
//       // result
//       val subgoals = List(goal.copy(sketch = rest))
